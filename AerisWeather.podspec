Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |ss|
    ...
    ss.vendored_frameworks = 'lib/AerisCore.framework'
    ss.framework = 'Foundation'
  end

  s.subspec 'CoreUI' do |ss|
    ss.header_dir = 'AerisCoreUI'
    ss.vendored_frameworks = 'lib/AerisCoreUI.framework'
    ss.framework = 'UIKit'
  ...
  s.subspec 'Data' do |ss|
    ...
    ss.vendored_frameworks = 'lib/AerisWeatherKit.framework'
    ss.dependency 'AerisWeather/CoreUI'
  end

  s.subspec 'Maps' do |ss|
    ss.header_dir = 'AerisMapKit'
    ss.vendored_frameworks = 'lib/AerisMapKit.framework'
    ss.framework = 'MapKit'
  ...
  s.subspec 'Mapbox' do |ss|
    ...
    ss.vendored_frameworks = 'lib/AerisMapboxMapKit.framework'
  ...
  s.subspec 'Google' do |ss|
    ...
    ss.vendored_frameworks = 'lib/AerisGoogleMapKit.framework'
