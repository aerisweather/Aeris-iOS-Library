...
- (instancetype)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
	...
	if (self) {
		...
		[sectionData addObject:@{@"name": @"Debug", @"items": @[
										 @{@"name": @"Device ID", @"value": [[Preferences sharedInstance] userIdentifier]}]}];
...
- (void)viewDidLoad {
	...
	[tableView registerClass:[GroupedTableViewCell class] forCellReuseIdentifier:valueCellIdentifier];
