...
typedef NSString * _Nullable (^AWFGraphTickFormatter)(CGFloat value);
 ...
 */
@property (readonly, strong, nonatomic, nullable) UIView *gridView;
 ...
 */
@property (nonatomic, strong, nullable) NSArray *tickValues;
 ...
 */
@property (nonatomic, strong, nullable) UIColor *tickColor;

/**
 *  The color used for the axis grid lines.
 */
@property (nonatomic, strong, nullable) UIColor *gridColor;
 ...
 */
@property (nonatomic, strong, nullable) AWFTextStyleSpec *textStyle;
 ...
 */
- (void)setTickFormatter:(nullable AWFGraphTickFormatter)formatter;
