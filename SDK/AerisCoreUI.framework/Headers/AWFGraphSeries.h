 ...
 */
@property (readonly, nonatomic, nullable) NSArray *items;
 ...
 */
@property (nonatomic, assign, nullable) id<AWFGraphSeriesDelegate> delegate;
 ...
 */
+ (instancetype)seriesWithItems:(nullable NSArray *)items;
 ...
 */
- (void)loadSeriesDataWithCompletion:(void (^)(void))completionBlock;
