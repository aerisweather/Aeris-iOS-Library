...
#import <AerisCoreUI/AWFGraphSeries.h>
...
typedef NSString * _Nullable (^AWFGraphValueFormatter)(CGFloat value);
 ...
 *
 *  The array can contain be array of arrays (`@[@[x1, y1], @[x2, y2]]`), an array of `AWFSeriesPoint` instances or an array of `AWFWeatherObject` instances 
 ...
 */
@property (readonly, nonatomic, nullable) NSArray *points;

/**
 *  The minimum date found within the series data, if any.
 */
@property (readonly, nonatomic, nullable) NSDate *minDate;

/**
 *  The maximum date found within the series data, if any.
 */
@property (readonly, nonatomic, nullable) NSDate *maxDate;
