...
/**
 ...
 @return An `AWFMapCoordinateBounds` instance with the calculated coordinates for the four corners and center.
 */
- (AWFMapCoordinateBounds *)af_coordinateBoundsForTileAtX:(NSUInteger)x y:(NSUInteger)y;
