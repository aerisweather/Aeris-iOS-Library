...
/**
 An `AWFFireOutlook` object represents data returned by the [**fires/outlook** endpoint](https://www.aerisweather.com/support/docs/api/reference/endpoints/fires-outlook/)
 of the Aeris Weather API.
 */
@interface AWFFireOutlook : AWFWeatherObject
